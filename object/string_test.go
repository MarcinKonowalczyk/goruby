...
func TestStringAdd(t *testing.T) {
	...
	for _, testCase := range tests {
		ctx := call.NewContext[ruby.Object](context.Background()).WithReceiver(NewString("foo"))
...
func Test_StringGsub(t *testing.T) {
	...
	for _, testCase := range tests {
		ctx := call.NewContext[ruby.Object](context.Background()).WithReceiver(NewString("foobar"))

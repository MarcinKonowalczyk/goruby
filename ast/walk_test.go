...
import (
	...
	tt "github.com/MarcinKonowalczyk/goruby/testutils/assert"
)
...
func Test_Parent(t *testing.T) {
	t.Run("parent found", func(t *testing.T) {
		...
		tt.That(t, ok, "Expected child to be contained within root, was not")
		tt.That(t, reflect.DeepEqual(parent, p), "Expected parent to equal\n%+#v\n\tgot\n%+#v\n", parent, p)
	})
	t.Run("parent is root", func(t *testing.T) {
		...
		tt.That(t, !ok, "Expected bool to return false")
	})
	t.Run("child not found", func(t *testing.T) {
		...
		tt.That(t, !ok, "Expected child not to be contained within root")
	})
}
...
func Test_Path(t *testing.T) {
	t.Run("child found", func(t *testing.T) {
		...
		tt.That(t, reflect.DeepEqual(expected, path), "Expected AST path to equal\n%+#v\n\tgot\n%+#v\n", expected, path)
	})
	t.Run("child not found", func(t *testing.T) {
		root := &Program{
			Statements: []Statement{
...
func Test_treeToList(t *testing.T) {
	...
	tt.That(t, reflect.DeepEqual(expected, actual), "Expected list to equal\n%+#v\n\tgot\n%+#v\n", expected, actual)
}
...
func Test_Contains(t *testing.T) {
	t.Run("found", func(t *testing.T) {
		...
		tt.That(t, ok, "Expected node to be within statement, was not")
	})
	t.Run("not the same pointer", func(t *testing.T) {
		...
		tt.That(t, !ok, "Expected node not to be within statement")
